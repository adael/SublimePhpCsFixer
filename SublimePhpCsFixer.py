...
def format_contents(contents, directory):
    """
    ...
    """
    if directory:
        fd, tmp_file = tempfile.mkstemp('', '', directory)
    else:
...
def get_file_directory():
    variables = sublime.active_window().extract_variables()
    return variables['file_path'] if 'file_path' in variables else None
    ...
    def run(self, edit):
        try:
            ...
            if contents:
                ...
                formatted = format_contents(contents, directory)
